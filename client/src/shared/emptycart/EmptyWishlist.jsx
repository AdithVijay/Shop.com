...
export default function EmptyWishlist() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[300px] mt-24 text-center">
        ...
        {mounted && (
          <>
            <FloatingItem delay={0}>
              <Gift className="w-6 h-6 text-primary/40 absolute -top-6 left-6" />
            </FloatingItem>
            ...
            <FloatingItem delay={1.5}>
              <Gift className="w-6 h-6 text-primary/50 absolute bottom-6 right-10" />
            </FloatingItem>
          </>
        )}
      </div>
      ...
      >
        Your wishlist is looking empty
      </motion.h3>
      ...
      >
        Start building your dream wishlist! Explore our collections and save your favorites now.
      </motion.p>
    </div>
  )
}